...
const About: React.FC = () => {
  return (
    <section id="despre" className="py-20 bg-haero-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-haero-dark mb-4">
            Despre <span className="text-haero-yellow-600">HAERO</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 text-center shadow-raised hover:shadow-lifted transition-all duration-200 hover:-translate-y-0.5 border-t-4 border-haero-yellow">
            <div className="w-16 h-16 bg-haero-yellow-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-haero-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
