  ...
  return (
    <><SEO title="Călătorii cu AEE" description="Sfaturi utile pentru călătoriile persoanelor cu angioedem ereditar: pregătirea medicamentelor, carduri de urgență și resurse." path="/calatorii" /><div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-haero-dark mb-4">
              Călătorii cu <span className="text-haero-yellow-600">AEE</span>
            </h1>
            ...
            <p className="text-lg text-haero-gray-500 max-w-3xl mx-auto leading-relaxed">
              Indiferent dacă plecați în interes de serviciu sau pentru vacanță, iată câteva lucruri de luat în considerare când vă pregătiți pentru călătorie.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-haero-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-haero-dark mb-4 text-center">Sfaturi utile pentru planificarea călătoriei</h2>
          <p className="text-haero-gray-500 text-center max-w-2xl mx-auto mb-12 leading-relaxed">
            O pregătire atentă vă poate ajuta să călătoriți în siguranță și cu încredere.
          </p>
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-raised border-l-4 border-haero-yellow-600">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-haero-dark mb-2 text-lg">Îngrijire medicală la destinație</h3>
                  <p className="text-haero-gray-500 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-raised border-l-4 border-haero-yellow-700">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-haero-dark mb-2 text-lg">Medicamente în bagajul de mână</h3>
                  <p className="text-haero-gray-500 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-raised border-l-4 border-haero-blue">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-haero-dark mb-2 text-lg">Suficiente medicamente</h3>
                  <p className="text-haero-gray-500 leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-haero-dark mb-4 text-center">Resurse utile pentru călătorie</h2>
          <p className="text-haero-gray-500 text-center max-w-2xl mx-auto mb-12 leading-relaxed">
            HAEi oferă instrumente digitale gratuite care vă pot ajuta să gestionați AEE în timpul călătoriilor.
          </p>
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* HAEi Companion App */}
            <div className="bg-haero-yellow-50 rounded-2xl p-6 border border-haero-yellow-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-haero-dark mb-3 text-xl">Aplicația HAEi Companion</h3>
                  <p className="text-haero-gray-700 leading-relaxed mb-3">
                    Aplicația HAEi Companion vă oferă acces rapid la informații esențiale în timpul călătoriei:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-haero-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-haero-gray-700 text-sm">Carduri de urgență în multe limbi</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-haero-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-haero-gray-700 text-sm">Listă de medici și spitale care cunosc AEE</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-haero-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-haero-gray-700 text-sm">Informații despre organizațiile HAE locale</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-haero-yellow-50 rounded-2xl p-6 border border-haero-yellow-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-haero-dark mb-3 text-xl">HAE TrackR</h3>
                  <p className="text-haero-gray-700 leading-relaxed mb-3">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-haero-gray-700 text-sm">Jurnal digital al atacurilor de AEE</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-haero-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-haero-gray-700 text-sm">Înregistrarea tratamentelor administrate</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-haero-yellow-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-haero-gray-700 text-sm">Rapoarte utile pentru consultații medicale</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-haero-yellow-50 rounded-2xl p-6 border border-haero-yellow-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-haero-dark mb-3 text-xl">Nu uitați</h3>
      ...
      <section className="py-12 bg-haero-yellow-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            <Link to="/femei-si-sarcina" className="text-haero-yellow-600 font-semibold hover:text-haero-yellow-700 transition-colors">
              ← Femei și Sarcina
            </Link>
            <Link to="/despre-haei" className="text-haero-yellow-600 font-semibold hover:text-haero-yellow-700 transition-colors sm:text-right">
              Despre HAEi →
            </Link>
          </div>
        </div>
