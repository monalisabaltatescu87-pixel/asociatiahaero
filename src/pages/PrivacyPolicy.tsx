...
const PrivacyPolicy: React.FC = () => {
  return (
    <><SEO title="Politica de Confidențialitate" description="Politica de confidențialitate a Asociației HAERO — cum colectăm, folosim și protejăm datele tale personale." path="/politica-confidentialitate" /><div className="pt-20">
